...
import { getAdminProductById, productStatus } from "@/services/service";
            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Button className="rounded-xl bg-zinc-900 hover:bg-zinc-800 dark:bg-zinc-50 dark:hover:bg-zinc-200 dark:text-zinc-900 flex items-center gap-2">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                        ...
                        { label: "Feedback Score", value: product.rating, icon: Star, color: "text-yellow-500", suffix: "/ 5.0" },
                        { label: "Review Count", value: product.numReviews, icon: ShoppingBag, color: "text-purple-500", suffix: "Reviews" },
                        { label: "Price Point", value: `₹${product.price}`, icon: DollarSign, color: "text-green-500", suffix: "Retail" },
                    ].map((stat, i) => (
                    ...
                    <div className="lg:col-span-2">
                        <Tabs defaultValue="overview" className="w-full">
                            ...
                            <div className="mt-6 space-y-6">
                                ...
                                {/* Feedback Content */}
                                <TabsContent value="reviews" className="m-0 space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
                                    <Card className="border-none shadow-sm bg-white dark:bg-zinc-900">
                                        <CardHeader>
                                            <div className="flex justify-between items-start">
                                                <div>
                                                    <CardTitle className="text-base font-bold">Customer Loyalty</CardTitle>
                                                    <CardDescription>Market reception and feedback metrics.</CardDescription>
                                                </div>
                                                <div className="text-right">
                                                    <div className="text-3xl font-black text-zinc-900 dark:text-white">{product.rating || "0.0"}</div>
                                                    <div className="flex justify-end gap-0.5 text-yellow-400 mt-1">
                                                        {[1,2,3,4,5].map(s => <Star key={s} size={12} fill={s <= (product.rating || 0) ? "currentColor" : "none"} />)}
                                                    </div>
                                                    <p className="text-[10px] text-zinc-500 mt-1 uppercase font-bold tracking-tighter">{product.numReviews} Total Reviews</p>
                                                </div>
                                            </div>
                                        </CardHeader>
                                        <CardContent>
                                            <div className="space-y-4">
                                                {[5,4,3,2,1].map((star) => {
                                                    const percentage = product.numReviews > 0 ? (star === 5 ? (product.rating >= 4.5 ? 85 : 0) : 0) : 0;
                                                    return (
                                                ...
                                                <Button variant="outline" className="w-full rounded-xl border-zinc-200 dark:border-zinc-800 text-xs text-zinc-500 h-10 mt-2">
